...
<div class="allcontain">
	...
	<nav class="topnavbar navbar-default topnav">
        ...
        <div>
         <p style="font-size:50px;"><img src="img/Car-Logo-PNG-Clipart.png" style="width:15%;margin-top:10px;" alt="logo">CarShowRoom</p>
	...
	<div id="carousel-up" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner " role="listbox">
			<div class="item active">
				<img src="upload/verna.png" alt="oldcar">
				<div class="carousel-caption">
					<h2>Car Showroom</h2>
					<p>This is use for managing car ,<br>
						 </p>
				</div>
			</div>
			<div class="item">
